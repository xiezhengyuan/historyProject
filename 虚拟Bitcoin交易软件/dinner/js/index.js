...
Q.gridbtn_zhuan= function(tableid,dataid){
	return "<button title=\"确认提现\" class=\"btn btn-danger btn-xs\" style=\"color:#f60;margin-left:3px;\" onclick=\"zhuan_"+tableid+"(" + dataid + ")\">确认提现</button>";
}
