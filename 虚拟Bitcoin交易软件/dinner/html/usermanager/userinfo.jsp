...
<div class="row">
	...
	<span class="glyphicon glyphicon-plus">新增用户</span>
	</button> 
...
var url = Q.url+"/manageuserinfo/queryuserinfo.action";

var colModel = [
                { label: 'ID', name: 'id',align :'center',hidden:true,sortable : false,key:true },
                { label: '帐号', name: 'username',align :'center', sortable : false },
                { label: '密码', name: 'password',align :'center', sortable : false },
                { label: '手机', name: 'mobile',align :'center', sortable : false },
                { label: '昵称', name: 'nickname',align :'center',sortable : false },
               /*  { label: '姓名', name: 'name',align :'center',sortable : false }, */
               /*  { label: '个人简介', name: 'intro',align :'center',sortable : false }, */
                { label: '总资产', name: 'allgolds',align :'center',sortable : false },
                { label: '可用资产', name: 'ugolds',align :'center',sortable : false },
                { label: '冻结资产', name: 'bgolds',align :'center',sortable : false },
                { label: '历史交易次数', name: 'all',align :'center',sortable : false },
             /*    { label: '累计交易量', name: 'volume',align :'center',sortable : false }, */
             /*    { label: '邮箱', name: 'email',align :'center',sortable : false },
                { label: '身份证', name: 'paparno',align :'center',sortable : false }, */
...
//解禁
function unban_company_grid_table(id){
		Q.confirm("确定吗？",function(r){
			if(r){
				$._ajax({
					url:Q.url+"/manageuserinfo/unban.action",
					data:{"id":id},
				    success:function(data){
				    	if(data.op=="success"){
...
function addcompany(){
	var _url= 'usermanager/adduser.jsp';
