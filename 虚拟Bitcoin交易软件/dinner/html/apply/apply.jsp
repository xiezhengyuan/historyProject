...
var url = Q.url+"/feedback/queryApply.action";

var colModel = [
                { label: 'ID', name: 'id',align :'center',hidden:true,sortable : false,key:true },
               
                { label: '昵称', name: 'nickname',align :'center', sortable : false },
                { label: '用户电话', name: 'mobile',align :'center', sortable : false },
                { label: '提现地址', name: 'address',align :'center', sortable : false },
                { label: '提现数量', name: 'amount',align :'center', sortable : false },
...
function zhuan_company_grid_table(id){
	Q.confirm("确定吗？",function(r){
		if(r){
			$._ajax({
				url:Q.url+"/applyinfo/zhuanApply.action",
				data:{"applyid":id},
