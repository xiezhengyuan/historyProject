			...
			<div id="sidebar" class="sidebar                  responsive">
				...
				<ul class="nav nav-list">
					...
					<%-- <c:forEach items="${menu}" var="menu">
					 ...
					 <li class="">
						<a href="javascript:;" vhref="usermanager/userinfo.jsp" vid="1" vname="用户管理" class="dropdown-toggle">
						 ...
						 <li class="">
						<a href="javascript:;" vhref="order/order.jsp" vid="2" vname="订单管理" class="dropdown-toggle">
							<i class="menu-icon fa fa-group"></i>
							<span class="menu-text">
								订单管理
							</span>
					...
					<li class="">
						<a href="javascript:;" vhref="bannerimg/bannerinfo.jsp" vid="3" vname="banner管理" class="ropdown-toggle">
							<i class="menu-icon fa fa-group"></i>
							<span class="menu-text">
								banner管理
							</span>
					...
					<li class="">
						<a href="javascript:;" vhref="invite/invite.jsp" vid="4" vname="邀请管理" class="ropdown-toggle">
							<i class="menu-icon fa fa-group"></i>
							<span class="menu-text">
								费率设置
							</span>
						...
						<li class="">
						<a href="javascript:;" vhref="feedback/feedback.jsp" vid="5" vname="意见反馈" class="ropdown-toggle">
							<i class="menu-icon fa fa-group"></i>
							<span class="menu-text">
								意见反馈
							</span>
						...
						<li class="">
						<a href="javascript:;" vhref="charge/charge.jsp" vid="6" vname="手续费管理" class="ropdown-toggle">
							<i class="menu-icon fa fa-group"></i>
							<span class="menu-text">
								手续费管理
							</span>
						...
						<li class="">
						<a href="javascript:;" vhref="userrecharge/userrecharge.jsp" vid="7" vname="充值提现管理" class="ropdown-toggle">
							<i class="menu-icon fa fa-group"></i>
							<span class="menu-text">
							充值提现管理
							</span>
					...
					<li class="">
						<a href="javascript:;" vhref="address/address.jsp" vid="8" vname="充值提现管理" class="ropdown-toggle">
							<i class="menu-icon fa fa-group"></i>
							<span class="menu-text">
							地址管理
							</span>
					...
					<li class="">
						<a href="javascript:;" vhref="apply/apply.jsp" vid="7" vname="提现申请管理" class="ropdown-toggle">
							<i class="menu-icon fa fa-group"></i>
							<span class="menu-text">
							提现申请管理
							</span>
