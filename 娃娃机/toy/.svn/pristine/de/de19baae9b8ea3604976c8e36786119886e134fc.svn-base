...
function _114(_115){
var _116=[];
$(_115).find(".tree-checkbox1,.tree-checkbox2").each(function(){
...
var vtarget=$(_6cc).attr("vtarget");
for(var i=0;i<_6cd.length;i++){
var _6d0=$("<input type=\"hidden\" class=\"combo-value\">").appendTo(_6cf);
if(name){
	//edit by wuwen
	if(vtarget!=null&&vtarget.length>0)_6d0.attr("name",vtarget);
	else _6d0.attr("name",name);
	//edit by wuwen
}
_6d0.val(_6cd[i]);
}
