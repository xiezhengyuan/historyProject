				...
				<ul class="nav nav-list">
					...
					<li class="">
						...
						<ul class="submenu nav-show" style="display: none;">
                        	<li class="">
								<a href="javascript:;" vhref="device/machine.jsp" vid="3" vname="娃娃机管理" class="dropdown-toggle">
							...
							<li class="">
								<a href="javascript:;" vhref="device/toy.jsp" vid="4" vname="玩具管理" class="dropdown-toggle">
									<i class="menu-icon fa fa-user"></i>
									<span class="menu-text">
										玩具管理
									</span>
						...
						<!-- 	<li>
								<a href="javascript:;" vid="5" vhref="device/toystype.jsp" >
							      	<i class="menu-icon fa fa-money"></i>
							       	<span class="menu-text">
										玩具分类管理
									</span>
					...
					<li class="">
						<a href="javascript:;" vhref="device/deliveryapply.jsp" vid="6" vname="物流管理" class="dropdown-toggle">
					...
					<li class="">
						<a href="javascript:;" vhref="ptreportforms/inandpout.jsp" vid="7" vname="统计" class="dropdown-toggle">
