   ...
   <input type="hidden" class="form-control" id="toysid" name="id" placeholder="">
				<div class="form-group">
				  ...
				  <div class="form-group">
					...
					<div class="form-group">
					<label for="empid" class="col-sm-2 control-label">玩具所有人</label>
					<div class="col-sm-10" style="width: 20%">
					  <select  class="form-control" id="empid" name="empid" msg="请玩具所有人" vtype="combo">
