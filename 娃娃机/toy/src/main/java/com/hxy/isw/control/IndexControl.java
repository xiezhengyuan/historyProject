...
import com.hxy.isw.thread.ChanegeUserMachineState;
...
public class IndexControl {
	...
	/*	//启动文件检查
		...
		//启动ChanegeUserMachineState
		ChanegeUserMachineState cums = new ChanegeUserMachineState();
		ThreadPoolManager.exec(cums);*/
	}
	...
	private void  initialize(){
		...
		ChanegeUserMachineState.databaseHelper = databaseHelper;
		NIOSServer.databaseHelper = databaseHelper;
	}
