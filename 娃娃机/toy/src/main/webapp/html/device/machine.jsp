...
<div class="page-header">
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<td><label for="ftoysid" class="control-label" style="margin-left:5px;">玩具：</label></td><td><select type="text" id="ftoysid" ></select></td>
			</tr>
			</table>
...
var url = Q.url+"/device/machineList.action";
...
var colModel = [
                ...
                { label: '喵币', name: 'balance',align :'center', sortable : false },
...
function detail_mc_grid_table(id){
	var _url= 'device/machinedetail.jsp?machineinfoid='+id;
	
	Q.viewJsp(Q.page_content,_url);
}

function bind_mc_grid_table(id){
var _url= 'device/bindtoys.jsp?machineinfoid='+id;
...
function addmachine(){
	var _url= 'device/addmachine.jsp';
