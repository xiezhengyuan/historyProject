...
<div class="page-header">
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<td><label for="toystype" class="control-label" style="margin-left:5px;">玩具类型：</label></td><td><select type="text" id="ftoystypeid" ></select></td>
			</tr>
			</table>
	...
	<button id="addtoyinfobtn" class="btn btn-purple btn-sm" onclick="addtoysinfo()" data-placement="top" title="新增" data-toggle="modal" data-target="#addtoyinfo">
...
var url = Q.url+"/device/toysinfoList.action";
...
function detail_ti_grid_table(id){
	var _url= 'device/toydetail.jsp?id='+id;
	
	Q.viewJsp(Q.page_content,_url);
}

function addtoysinfo(){
	
var _url= 'device/toydetail.jsp';
