...
function queryexpressage(){
	$._ajax({
		url: Q.url+"/ServiceDeliveryapplyControl/queryexpressage.action",
		data:{},
		success: function(data){
			...
			for(var i=0;i<data.rows.length;i++){
				...
				opts+= '<option value="'+expressage.expressagecompany+'">'+expressage.expressagecompany+'</option>';
			}
...
$('#saveorder').click(function(){
	...
	$._ajax({
		url: Q.url+"/ServiceDeliveryapplyControl/addexpressageinfo.action",
		data:{"expressagecompany":$("#expressagecompany").val(),"expressageno":$("#expressageno").val(),"id":id},
