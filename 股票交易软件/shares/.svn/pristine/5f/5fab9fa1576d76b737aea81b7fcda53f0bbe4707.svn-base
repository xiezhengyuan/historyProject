  		...
  		<div class="modal-body"  style="overflow-y: auto;">
            ...
            <input type="hidden" class="form-control" id="userinfoid" name="id" placeholder="">
				<div class="form-group">
					...
					<div class="col-sm-10">
					<div id="updatagolds"> </div>    
					<input type="text"  value=""  class="form-control" name="golds"  id="gold"  readonly="readonly">
					<button type="button" id="gold"  title="点击修改" class="btn btn-warning btn-xs"  onclick="updatagolds()" style="height: 33px; width:40px "><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
					</button> 
					</div>
					</div>
				  ...
				  <div class="form-group">
					...
					<div class="form-group">
					<label for="cardno" class="col-sm-2 control-label">推广经理</label>
					<div class="col-sm-10">
					<input type="text" class="form-control" name="bossname"  id="bossname"  readonly="readonly">
					</div>
					</div>
					
					<div class="form-group">
					<label for="cardno" class="col-sm-2 control-label">推广公司</label>
					<div class="col-sm-10">
					<input type="text" class="form-control" name="companyname"  id="companyname"  readonly="readonly">
					</div>
					</div>
			</form>
			</div>
...
$._ajax({
	...
	success: function(user){	
		...
		$("#bossname").val(user.bossname); 	
		$("#companyname").val(user.companyname); 	
	}
});	


function updatagolds(){
	
	var _url= 'usermanage/updategolds.jsp?';
     Q.viewJsp("#updatagolds",_url);
}
</script>
