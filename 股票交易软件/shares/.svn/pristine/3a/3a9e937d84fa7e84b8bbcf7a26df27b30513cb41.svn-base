...
<div class="page-header">
	<h1>
	 ...
	 <div class="modal-header" style="margin-top:20px;">
			...
			<tr>
			<td><label for="username" class="control-label" style="margin-left:5px;">股票名称：</label></td><td><input type="text" id="keyword8" /></td>
...
Q.grid_selector = "order_grid_table2";
Q.pager_selector = "order_grid_pager2";
...
function detail_order_grid_pager2(id){
