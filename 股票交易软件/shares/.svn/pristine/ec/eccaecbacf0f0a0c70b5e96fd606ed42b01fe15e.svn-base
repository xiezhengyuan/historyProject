...
<div role="tabpanel" class="tab-pane active" id="tab_cash_state2">
								<!-- jqgrid 用户列表-->
							<table id="cashstate2_grid_table"></table>
							<!-- jqgrid 页码栏-->
							<div id="cashstate2_grid_pager"></div>

</div>

<script>
Q.grid_selector = "cashstate2_grid_table";
Q.pager_selector = "cashstate2_grid_pager";
...
var colModel = [
                ...
                { label: '打款时间', name: 'time',align :'center',sortable : false }
                /* {  
