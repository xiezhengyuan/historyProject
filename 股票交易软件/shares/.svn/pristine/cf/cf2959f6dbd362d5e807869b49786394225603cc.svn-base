...
public class AppServiceExampleControl {
	 ...
	 * @param session
	 */
	@RequestMapping(method = RequestMethod.POST, value = "/quotation4wh")
	public void quotation4wh(HttpServletRequest request,HttpServletResponse response,HttpSession session){
		String userid = request.getParameter("userid");
		int start = request.getParameter("page")==null?1:Integer.parseInt(request.getParameter("page"));
		int limit = request.getParameter("rows")==null?ConstantUtil.LIMIT:Integer.parseInt(request.getParameter("rows"));
		...
		try{
			String json = appServiceExample.quotation4wh(userid,start,limit);
			JsonUtil.success2client(response, json);
		}catch(Exception e){
			String mess = e.getMessage();
			JsonUtil.success2client(response, "{\"msg\":\"fail\",\"info\":\""+mess+"\"}");
	 ...
	 * @param session
	 */
	@RequestMapping(method = RequestMethod.POST, value = "/quotation4us")
	public void quotation4us(HttpServletRequest request,HttpServletResponse response,HttpSession session){
		String userid = request.getParameter("userid");
		int start = request.getParameter("page")==null?1:Integer.parseInt(request.getParameter("page"));
		int limit = request.getParameter("rows")==null?ConstantUtil.LIMIT:Integer.parseInt(request.getParameter("rows"));
		...
		try{
			String json = appServiceExample.quotation4us(userid,start,limit);
			JsonUtil.success2client(response, json);
		}catch(Exception e){
			String mess = e.getMessage();
			JsonUtil.success2client(response, "{\"msg\":\"fail\",\"info\":\""+mess+"\"}");
	...
	public void sharesdetail(HttpServletRequest request,HttpServletResponse response,HttpSession session){
		...
		String type = request.getParameter("type");//hs 沪深   、 us 美股  、 wh  外汇
		String warehouseid = request.getParameter("warehouseid");//hs 沪深   、 us 美股  、 wh  外汇
		
		try{
			String json = appServiceExample.sharesdetail(userid,shareid,code,type,warehouseid);
			JsonUtil.success2client(response, json);
		}catch(Exception e){
			String mess = e.getMessage();
			JsonUtil.success2client(response, "{\"msg\":\"fail\",\"info\":\""+mess+"\"}");
	 ...
	 * @param session
	 */
	@RequestMapping(method = RequestMethod.POST, value = "/sharesKlineUs")
	public void sharesKlineUs(HttpServletRequest request,HttpServletResponse response,HttpSession session){
		String userid = request.getParameter("userid");
		String shareid = request.getParameter("shareid");
		String code = request.getParameter("code");
		String type = request.getParameter("type");//分时mh  5 = 5分k线(默认) ，30 = 30分k线，60 = 60分k线，day = 日k线，week = 周k线，month = 月k线
		...
		try{
			String json = appServiceExample.sharesKlineUs(userid,shareid,code,type);
			JsonUtil.success2client(response, json);
		}catch(Exception e){
			String mess = e.getMessage();
			JsonUtil.success2client(response, "{\"msg\":\"fail\",\"info\":\""+mess+"\"}");
	...
	public void documentary(HttpServletRequest request,HttpServletResponse response,HttpSession session){
		...
		try{
			String json = appServiceExample.documentary(userid,exampleid,type,value);
			JsonUtil.success2client(response, json);
		}catch(Exception e){
			String mess = e.getMessage();
			JsonUtil.success2client(response, "{\"msg\":\"fail\",\"info\":\""+mess+"\"}");
	...
	public void planofnew(HttpServletRequest request,HttpServletResponse response,HttpSession session){
		...
		String exampleid = request.getParameter("exampleid");
		String planid = request.getParameter("planid");
		String tag = request.getParameter("tag");//0买入-1卖出
		int rows = request.getParameter("rows")==null?4:Integer.parseInt(request.getParameter("rows"));
	 ...
	 */
	@Transactional(propagation=Propagation.REQUIRED,rollbackFor=Exception.class)
	@RequestMapping(method = RequestMethod.POST, value = "/tradeoverview")
	public void tradeoverview(HttpServletRequest request,HttpServletResponse response,HttpSession session){
		String userid = request.getParameter("userid");
		String exampleid = request.getParameter("exampleid");
		...
		try{
			String json = appServiceExample.tradeoverview(userid,exampleid);
			JsonUtil.success2client(response, json);
		}catch(Exception e){
			String mess = e.getMessage();
			JsonUtil.success2client(response, "{\"msg\":\"fail\",\"info\":\""+mess+"\"}");
	 ...
	 * @param session
	 */
	@RequestMapping(method = RequestMethod.POST, value = "/historylog")
	public void historylog(HttpServletRequest request,HttpServletResponse response,HttpSession session){
		String userid = request.getParameter("userid");
		String exampleid = request.getParameter("exampleid");//牛人id。（不为空查的为牛人的历史记录，为空则是查当前登录的用户的历史记录）
		String type = request.getParameter("type");//-1所有  0沪深  1美股  2外汇
		int start = request.getParameter("page")==null?1:Integer.parseInt(request.getParameter("page"));
		int limit = request.getParameter("rows")==null?ConstantUtil.LIMIT:Integer.parseInt(request.getParameter("rows"));
		...
		try{
			String json = appServiceExample.historylog(userid,exampleid,type,start,limit);
			JsonUtil.success2client(response, json);
		}catch(Exception e){
			String mess = e.getMessage();
			JsonUtil.success2client(response, "{\"msg\":\"fail\",\"info\":\""+mess+"\"}");
	 ...
	 * @param session
	 */
	@RequestMapping(method = RequestMethod.POST, value = "/houselog")
	public void houselog(HttpServletRequest request,HttpServletResponse response,HttpSession session){
		String userid = request.getParameter("userid");
		String exampleid = request.getParameter("exampleid");//牛人id。（不为空查的为牛人的持仓，为空则是查当前登录的用户的持仓）
		String type = request.getParameter("type");//-1所有  0沪深  1美股  2外汇
		int start = request.getParameter("page")==null?1:Integer.parseInt(request.getParameter("page"));
		int limit = request.getParameter("rows")==null?ConstantUtil.LIMIT:Integer.parseInt(request.getParameter("rows"));
		...
		try{
			String json = appServiceExample.houselog(userid,exampleid,type,start,limit);
			JsonUtil.success2client(response, json);
		}catch(Exception e){
			String mess = e.getMessage();
			JsonUtil.success2client(response, "{\"msg\":\"fail\",\"info\":\""+mess+"\"}");
	 ...
	 * @param session
	 */
	@RequestMapping(method = RequestMethod.POST, value = "/followlog")
	public void followlog(HttpServletRequest request,HttpServletResponse response,HttpSession session){
		String userid = request.getParameter("userid");
		//String exampleid = request.getParameter("exampleid");//牛人id。（不为空查的为牛人的持仓，为空则是查当前登录的用户的持仓）
		String type = request.getParameter("type");//  0沪深  1美股  2外汇
		String tag = request.getParameter("tag");//  0正在跟随  -1历史跟随
		int start = request.getParameter("page")==null?1:Integer.parseInt(request.getParameter("page"));
		int limit = request.getParameter("rows")==null?ConstantUtil.LIMIT:Integer.parseInt(request.getParameter("rows"));
		
		
		try{
			String json = appServiceExample.followlog(userid,type,tag,start,limit);
			JsonUtil.success2client(response, json);
		}catch(Exception e){
			String mess = e.getMessage();
			JsonUtil.success2client(response, "{\"msg\":\"fail\",\"info\":\""+mess+"\"}");
	 ...
	 * @param session
	 */
	@RequestMapping(method = RequestMethod.POST, value = "/tradeinfo")
	public void tradeinfo(HttpServletRequest request,HttpServletResponse response,HttpSession session){
		String userid = request.getParameter("userid");
		String type = request.getParameter("type");//-1所有  0沪深  1美股  2外汇
		int start = request.getParameter("page")==null?1:Integer.parseInt(request.getParameter("page"));
		int limit = request.getParameter("rows")==null?ConstantUtil.LIMIT:Integer.parseInt(request.getParameter("rows"));
		...
		try{
			String json = appServiceExample.tradeinfo(userid,type,start,limit);
			JsonUtil.success2client(response, json);
		}catch(Exception e){
			String mess = e.getMessage();
			JsonUtil.success2client(response, "{\"msg\":\"fail\",\"info\":\""+mess+"\"}");
