...
<div class="modal-dialog">
	...
	<div class="row">
		<div class="col-xs-12">
			<h4>&nbsp;&nbsp;&nbsp;&nbsp;转入公司：<span id="incompany" style="font-size: 15px;"></span>&nbsp;&nbsp;&nbsp;&nbsp;转入业务员：<span id="insalesman" style="font-size: 15px;"></span>
...
var colModel4 = [
                ...
                { label: '转出业务员', name: 'outsalesman',align :'center', sortable : false,},
            	];
