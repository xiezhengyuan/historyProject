...
<div class="page-header">
	<h1>
	 ...
	 <div class="modal-header" style="margin-top:20px;">
			...
			<tr>
			<td><label for="username" class="control-label" style="margin-left:5px;">外汇名称：</label></td><td><input type="text" id="keyword1" /></td>
...
var url = Q.url+"/trading/queryforex.action";

var colModel = [
                { label: 'ID', name: 'id',align :'center',hidden:true,sortable : false,key:true },
                { label: '外汇名称', name: 'foreignexchangename',align :'center', sortable : false },
               
                { label: '买入', name: 'price',align :'center', sortable : false },
