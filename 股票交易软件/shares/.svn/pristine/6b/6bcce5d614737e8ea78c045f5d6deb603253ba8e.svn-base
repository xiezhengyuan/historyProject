...
<div class="page-header">
	<h1>
	 ...
	 <div class="modal-header" style="margin-top:20px;">
			...
			<tr>
			<td><label for="username" class="control-label" style="margin-left:5px;">外汇名称：</label></td><td><input type="text" id="keyword2" /></td>
...
<!-- panel1 start -->
  <div role="tabpanel" class="tab-pane active" id="tab_orderinfo_state0">
  		<!-- jqgrid 用户列表-->
							<table id="order3_grid_table"></table>
							<!-- jqgrid 页码栏-->
							<div id="order3_grid_pager"></div>
							<div>
...
Q.grid_selector = "order3_grid_table";
Q.pager_selector = "order3_grid_pager";

var url = Q.url+"/trading/queryforex1.action";
...
function detail_order3_grid_table(id){
