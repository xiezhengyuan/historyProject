...
<div class="page-header">
	<h1>
	 ...
	 <div class="modal-header" style="margin-top:20px;">
			...
			<tr>
			<td><label for="username" class="control-label" style="margin-left:5px;">股票名称：</label></td><td><input type="text" id="keyword6" /></td>
...
<!-- panel1 start -->
  <div role="tabpanel" class="tab-pane active" id="tab_orderinfo_state0">
  		<!-- jqgrid 用户列表-->
							<table id="order_grid_table5"></table>
							<!-- jqgrid 页码栏-->
							<div id="order_grid_pager5"></div>
							<div>
...
Q.grid_selector = "order_grid_table5";
Q.pager_selector = "order_grid_pager5";

var url = Q.url+"/trading/queryposition.action";
...
var colModel = [
                ...
                { label: '更新时间', name: 'time',align :'center', sortable : false },
...
function detail_order_grid_table5(id){
