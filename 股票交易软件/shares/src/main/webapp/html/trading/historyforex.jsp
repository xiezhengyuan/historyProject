...
<div class="page-header">
	<h1>
	 ...
	 <div class="modal-header" style="margin-top:20px;">
			...
			<tr>
			<td><label for="username" class="control-label" style="margin-left:5px;">外汇名称：</label></td><td><input type="text" id="keyword3" /></td>
...
<!-- panel1 start -->
  <div role="tabpanel" class="tab-pane active" id="tab_orderinfo_state0">
  		<!-- jqgrid 用户列表-->
							<table id="order5_grid_table"></table>
							<!-- jqgrid 页码栏-->
							<div id="order5_grid_pager"></div>
							<div>
...
Q.grid_selector = "order5_grid_table";
Q.pager_selector = "order5_grid_pager";

var url = Q.url+"/trading/queryhistoryforex.action";

var colModel = [
{ label: 'ID', name: 'id',align :'center',hidden:true,sortable : false,key:true },
{ label: '外汇名称', name: 'foreignexchangename',align :'center', sortable : false },

{ label: '买入', name: 'amount',align :'center', sortable : false },
{ label: '持仓手数', name: 'warehousenums',align :'center', sortable : false },
{ label: '金额($)', name: 'purchase',align :'center', sortable : false },
{ label: '卖出', name: 'sellout',align :'center', sortable : false },
...
function detail_order5_grid_pager(id){
