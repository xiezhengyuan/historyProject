...
<div class="page-header">
	<h1>
		...
		<small>
			...
			<tr>
			<td><label for="username" class="control-label" style="margin-left:5px;">标题：</label></td><td><input type="text" id="username" /></td>
			<td><label for="usermobile" class="control-label" style="margin-left:5px;">内容：</label></td><td><input type="text" id="usermobile" /></td>
			</tr>
			</table>
