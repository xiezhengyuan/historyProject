...
var url3 = Q.url+"/companychangeUser/querychangejl.action";

var colModel3 = [
                { label: 'ID', name: 'id',align :'center',hidden:true,sortable : false,key:true },
                { label: '转移人数', name: 'usernum',align :'center', sortable : false },
                { label: '转入业务员', name: 'outsalesman',align :'center', sortable : false },
                { label: '转入业务员', name: 'insalesman',align :'center', sortable : false },
...
function detail_order_grid_table3(id){
	...
	var _url= 'gengealuserchange/userchangedetail.jsp?id='+id;
	
	Q.viewJsp("#userchangedetail",_url);
}
