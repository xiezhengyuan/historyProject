...
<div class="row">
	...
	<button id="addempbtn" class="btn btn-purple btn-sm" onclick="addmanagers()" data-placement="top" title="新增" data-toggle="modal" data-target="#adduser">
	<span class="glyphicon glyphicon-plus">新增经理</span>
	</button> 
	</div>
...
function addmanagers(){
	var _url= 'employee/addmanager.jsp';
	
	Q.viewJsp('#div_addmanagers',_url);
}
