...
<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="form-horizontal" role="form" id="form_adduser">
					...
					<div class="col-sm-10">
					<select  id="target2" class="selectpicker" multiple data-hide-disabled="true" data-size="5" >
			...
			<!-- 		<tr>
			<td><label for="fsupplier" class="control-label"  style="margin-left:5px;">公司名称：</label></td><td><select type="text" id="target2" ><option value="-1"  selected>请选择</option></select></td>
...
$('#saveuser').click(function(){
	...
	$._ajax({
		url: Q.url+"/notic/addhnotice.action",
		data:o,
		success: function(data){
