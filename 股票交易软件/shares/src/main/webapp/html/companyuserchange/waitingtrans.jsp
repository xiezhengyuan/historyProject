...
#tochange:hover {
    box-shadow: 0 12px 16px 0 rgba(0,0,0,0.24),0 17px 50px 0 rgba(0,0,0,0.19);
       ...
       <div id="waitsel">
         ...
         <select id="selectjl1"  class="select2" onchange="queryywy1()">
	         ...
	         <option value="0">选择推广业务员</option>
	          ...
	          <input type="text" id="accname" placeholder="经理姓名/业务员姓名" />
       ...
       <div id="aftersel">
             <h4>指定业务员： </h4>
	         <select id="selectjl2"  class="select2" onchange="queryywy2()">
	         <option value="0">选择推广经理</option>
	         </select>
...
$('#selectjl1').change(function(){ 
	postData3 = getconditioncha();
	$("#"+Q.grid_selector1).setGridParam({postData:postData3,page:1}).trigger("reloadGrid"); 
})
